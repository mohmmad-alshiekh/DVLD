    ...
    public partial class MainForm : Form
    {
        ...
        private void _HandlePageChange()
        {
            ...
            else
            {
                ...
                DataTable dt = BusinessLayer.Person.GetAllPeople();
            ...
            else
            {
                ...
                DataTable dt = BusinessLayer.User.GetAllUsers();
        ...
        private void _LoadHomePageInfo()
        {
            try
            {
                ...
                DataRowCollection dataRow = BusinessLayer.Application.GetNumberOfApplications().Rows;
        ...
        private void _HandleApplicationsPageChange()
        {
            ...
            else
            {
                ...
                dgvApplicationsType.DataSource = BusinessLayer.ApplicationType.GetAllApplicationTypes();
            }
        ...
        private void _CancelledLocalDrivingLicenseApplication()
        {
            ...
            if (MessageBox.Show("Are you sure you want to cancelled it?", "DVLD", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                {
                    BusinessLayer.Application application = LocalDrivingLicenseApplication.GetLocalDrivingLicenseApplicationById(localDrivingLicenseId).Application;

                    if (application.Status != BusinessLayer.Application.enStatus.Completed)
                        application.Status = BusinessLayer.Application.enStatus.Cancelled;
                    else
                        return;
                    try
                    {
            ...
            if (MessageBox.Show("Are you sure you want to delete it?", "DVLD", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                ...
                if (localDrivingLicenseId != -1)
                {
                    ...
                    try
                    {
                        ...
                        {
                            if (BusinessLayer.Application.DeleteApplication(applicationId))
                                MessageBox.Show("The deletion process has been completed.", "DVLD", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            else
                                MessageBox.Show("operation failed.", "DVLD", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        }
        ...
        public void _LoadInternationalLicenseApplications()
        {
            try
            {
                ...
                DataTable dt = BusinessLayer.Application.GetApplicationsByTypeId(6);
