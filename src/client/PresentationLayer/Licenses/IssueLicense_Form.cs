...
using Utilities;
using static BusinessLayer.License;
...
namespace PresentationLayer.Licenses
{
    public partial class IssueLicense_Form : Form
    {
        ...
        private BusinessLayer.Application _Application;
        ...
        public IssueLicense_Form(BusinessLayer.Application application,LicenseClass licenseClass,string personNationalNo, int createdByUserId)
        {
            InitializeComponent();
        ...
        private void _LoadApplicationInformation()
        {
            ...
            {
                _Application = new BusinessLayer.Application();
                _Application.CreationDate = DateTime.Now;
                _Application.Status = BusinessLayer.Application.enStatus.New;
                _Application.CreationDate = DateTime.Now;
        ...
        private void _SaveFirstTimeLicense()
        {
            try
            {
                ...
                _Application.Status = BusinessLayer.Application.enStatus.Completed;
